...
#> 4    F     3      6       7      12 0.008037761 0.003048107 0.003048107
#> 5    F     4     12      13      24 0.096647218 0.037164944 0.037164944
#> 6    F     5     12      25      36 0.096379122 0.049272974 0.049272974
#> 7    F     6     12      37      48 0.096186277 0.059237985 0.059237985
#> 8    F     7     24      49      72 0.096002221 0.068170189 0.068170189
#> 9    F     8     24      73      96 0.095995832 0.051378664 0.051378664
#> 10   F     9    Inf      97     Inf 0.095696559 0.047140805 0.047140805
...
#>           pdea       poff           g
#> 1  0.014378771 0.02168272 1.000000000
#> 2  0.027224422 0.04358808 0.481647065
#> 3  0.023946873 0.04690149 0.223154337
#> 4  0.021661414 0.04927604 0.137574508
...
#> 11 0.013930244 0.02168767 1.000000000
#> 12 0.026638101 0.04360136 0.481800991
#> 13 0.024083055 0.04689818 0.223103543
#> 14 0.020662112 0.04930154 0.137965982
...
param$Milk$param
#>    sex class lclass cellmin cellmax      nupar          ff          fm
#> 1    F     0      1       0       0 0.00000000 0.000000000 0.000000000
#> 2    F     1      2       1       2 0.00000000 0.000000000 0.000000000
#> 3    F     2      4       3       6 0.00000000 0.000000000 0.000000000
#> 4    F     3      6       7      12 0.00802751 0.003120309 0.003120309
#> 5    F     4     12      13      24 0.09664722 0.038625627 0.038625627
#> 6    F     5     12      25      36 0.09637912 0.063062143 0.063062143
#> 7    F     6     12      37      48 0.09618628 0.069215740 0.069215740
#> 8    F     7     24      49      72 0.09600222 0.074918305 0.074918305
#> 9    F     8     24      73      96 0.09599583 0.064239262 0.064239262
#> 10   F     9    Inf      97     Inf 0.09569656 0.056054121 0.056054121
#> 11   M     0      1       0       0 0.00000000 0.000000000 0.000000000
#> 12   M     1      2       1       2 0.00000000 0.000000000 0.000000000
#> 13   M     2      4       3       6 0.00000000 0.000000000 0.000000000
#> 14   M     3      6       7      12 0.00000000 0.000000000 0.000000000
#> 15   M     4     12      13      24 0.00000000 0.000000000 0.000000000
#> 16   M     5     12      25      36 0.00000000 0.000000000 0.000000000
#> 17   M     6     12      37      48 0.00000000 0.000000000 0.000000000
#> 18   M     7     24      49      72 0.00000000 0.000000000 0.000000000
#> 19   M     8     24      73      96 0.00000000 0.000000000 0.000000000
#> 20   M     9    Inf      97     Inf 0.00000000 0.000000000 0.000000000
#>           pdea       poff           g
#> 1  0.015976660 0.02166505 1.000000000
#> 2  0.029990852 0.04352541 0.480919573
#> 3  0.025799405 0.04685642 0.222463252
#> 4  0.024186090 0.04921156 0.136586681
#> 5  0.014491265 0.05256438 0.055287947
#> 6  0.014450064 0.05796750 0.053300717
#> 7  0.014420378 0.06185407 0.051896501
#> 8  0.014392005 0.06556358 0.013602017
#> 9  0.014391020 0.06569234 0.013573233
#> 10 0.014344802 0.07172401 0.000000000
#> 11 0.015353960 0.02167194 1.000000000
#> 12 0.028757319 0.04355337 0.481244207
#> 13 0.024440703 0.04688948 0.222970138
#> 14 0.022344080 0.04925861 0.137307231
#> 15 0.011757145 0.05263842 0.056288824
#> 16 0.004035454 0.05827867 0.057078858
#> 17 0.004027148 0.06218588 0.055603919
#> 18 0.005605579 0.06586137 0.015620369
...
#>   .. ..$ xini   : num [1:18] 33.4 61.9 79.1 124.8 77.2 ...
#>   .. ..$ rep.val: num [1:18] 1.45 1.57 1.83 2.3 2.53 ...
#>   ..$ p0            : num 1000
#>  $ Meat:List of 5
#>   ..$ param         :List of 8
#>   .. ..$ param         :'data.frame':    20 obs. of  11 variables:
#>   .. ..$ parms         :List of 6
#>   .. ..$ NetProlificacy: num 1.12
#>   .. ..$ Mortality     : num 0.287
#>   .. ..$ offtake       : num [1:10] 0 0.15 0.25 0.3 0.5 0.7 0.78 0.81 0.81 0.9
#>   .. ..$ female.offtake: NULL
#>   .. ..$ correctionfec : logi TRUE
#>   .. ..$ phi           : NULL
#>   ..$ lambda        : num 0.975
...
#>   .. ..$ cellmin: num [1:18] 1 3 7 13 25 37 49 73 97 1 ...
#>   .. ..$ cellmax: num [1:18] 2 6 12 24 36 ...
#>   .. ..$ xini   : num [1:18] 32.2 62.4 88.4 147.3 86.2 ...
#>   .. ..$ rep.val: num [1:18] 1.77 1.84 1.98 2.12 2.01 ...
#>   ..$ p0            : num 1000
#>  $ Wool:List of 5
#>   ..$ param         :List of 8
#>   .. ..$ param         :'data.frame':    20 obs. of  11 variables:
#>   .. ..$ parms         :List of 6
#>   .. ..$ NetProlificacy: num 1.04
#>   .. ..$ Mortality     : num 0.275
#>   .. ..$ offtake       : num [1:10] 0 0.15 0.25 0.35 0.37 0.43 0.5 0.57 0.57 0.8
#>   .. ..$ female.offtake: NULL
#>   .. ..$ correctionfec : logi TRUE
#>   .. ..$ phi           : NULL
#>   ..$ lambda        : num 0.985
...
#>   .. ..$ cellmin: num [1:18] 1 3 7 13 25 37 49 73 97 1 ...
#>   .. ..$ cellmax: num [1:18] 2 6 12 24 36 ...
#>   .. ..$ xini   : num [1:18] 31.6 59.6 82.4 132.3 85.8 ...
#>   .. ..$ rep.val: num [1:18] 1.62 1.73 1.84 2.07 2.17 ...
#>   ..$ p0            : num 1000
