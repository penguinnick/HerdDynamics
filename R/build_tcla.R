...
#'
#' @param female.ages a vector of numbers containing the length of age classes in years for females where c(0.5, 1, 1) corresponds to 6 months, 1 year, 2 years of age. If terminal age is not Inf, a truncated model will be produced.
